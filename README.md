...
一款面向高中英语命题研究的 Windows 桌面应用，帮助命题者在真题语料中快速检测课标词汇的覆盖情况。

---

## 功能特性

- **词汇检索**：内置 7700+ 课标词汇，按「真题词」「课标词」「拓展词」「超纲词」「专有词」五级分类，支持实时搜索和过滤。
- **语料分析**：支持导入 TXT / EPUB / PDF / DOCX 格式的真题语料，自动扫描并标记其中出现的词汇。
...
- **系统支持**：目前仅支持win10和win11，后续可能拓展版本和系统支持。
